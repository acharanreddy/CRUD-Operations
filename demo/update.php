...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_marks)){
        $marks_err = "Please enter the marks amount.";     
    ...
    if(empty($name_err) && empty($address_err) && empty($marks_err)){
        ...
        $sql = "UPDATE student SET name=?, marks=?,address=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_marks, $param_address, $param_id);
